...
export declare type TMenuOptionGetter = () => TMenuOption[];
export declare type TPageOverlayStore = {
...
export interface PageEditContextInterface extends CanBeActivated, CanControlEditMode, CanControlMenuPosition, CanGetContextMenuOptions, CanControlPageOverlay, DefinesLocalEditContext, CanControlLocalTooltipsVisibility {
    readonly id: string;
