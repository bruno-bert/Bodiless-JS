...
import { FieldProps, ChildFieldProps, SelectFieldProps } from 'informed';
 ...
 */
export declare type MenuOptionDefaultComponents = {
 ...
 */
export declare type IContextMenuItemProps = {
    /**
 ...
 */
export declare type TMenuOption = {
    /**
...
export declare type ButtonVariantProps = HTMLProps<HTMLDivElement> & {
    isActive?: boolean;
    isFirst?: boolean;
    isDisabled?: boolean;
};
declare type IconVariantProps = HTMLProps<HTMLSpanElement> & {
    isActive?: boolean;
};
/**
 * Type of the UI for the context menu.
 */
export declare type ContextMenuUI = {
...
export declare type IContextMenuProps = {
    children?: ReactNode;
    options?: TMenuOption[];
    ui?: ContextMenuUI;
...
export declare type ContextMenuFormProps = {
    ui?: ContextMenuUI;
    title?: string;
    description?: string;
    closeForm: (e: any) => void;
