...
declare type EditDataHandler<D> = {
    initialValueHandler?: (values: any) => D;
    submitValueHandler?: (values: D) => any;
};
export declare type FormBodyProps<P, D> = ContextMenuFormBodyProps<D> & {
    componentProps: P;
};
export declare type FormBodyRenderer<P, D> = (p: FormBodyProps<P, D>) => ReactNode;
export declare type EditButtonProps<D> = {
 ...
 */
export declare type OptionGroupDefinition = TMenuOption & {
    /**
...
export declare type EditButtonOptions<P = any, D = any> = Omit<OptionGroupDefinition, 'handler'> & {
    /**
...
export declare type UseBodilessOverrides<P = any, D = any, E = {}> = (props: P & EditButtonProps<D>) => Partial<EditButtonOptions<P, D> & E>;
export {};
//# sourceMappingURL=EditButtonTypes.d.ts.map